...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    // Useful for when static API methods that result in re-rendering are invoked during a drag.
...
var Calendar = /** @class */ (function () {
    ...
    // Selection
    // -----------------------------------------------------------------------------------------------------------------
    // this static method receives start/end dates in any format, with any timezone
