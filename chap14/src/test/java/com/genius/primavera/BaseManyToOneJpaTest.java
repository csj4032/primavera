...
/**
 * Chapter 13 - ManyToOne 관계 매핑 테스트를 위한 TestContainers 기반 클래스
 * MySQL 컨테이너를 사용하여 manyToOne 패키지 엔티티만 로드합니다.
 */
@Slf4j
@Testcontainers
public abstract class BaseManyToOneJpaTest {
    ...
    public static void setUpEntityManager() {
        ...
        entityManagerFactory = Persistence.createEntityManagerFactory("manyToOne", properties);
