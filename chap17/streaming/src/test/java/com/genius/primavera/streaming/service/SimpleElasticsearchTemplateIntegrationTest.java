...
@SpringBootTest(classes = SimpleElasticsearchTemplateIntegrationTest.TestConfiguration.class)
@EnableTestContainers({
    @EnableTestContainers.TestContainer(type = ContainerType.ELASTICSEARCH, name = "elasticsearch")
})
@ActiveProfiles("test")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@DisplayName("Simple ElasticsearchTemplate Integration Test with TestContainers")
class SimpleElasticsearchTemplateIntegrationTest {

    @Autowired
    private ElasticsearchOperations elasticsearchTemplate;

    private static final String INDEX_NAME = "product_catalog_simple_test";
    ...
    @Test
    @Order(5)
    @DisplayName("Should verify ElasticsearchTemplate operations work with TestContainers")
    void shouldVerifyElasticsearchTemplateOperationsWorkWithTestContainers() {
