...
-- 사용자 소셜 연결 정보 (ProviderType enum: 1=GOOGLE, 2=FACEBOOK, 3=KAKAO)  
INSERT INTO USER_CONNECTION (ID, EMAIL, PROVIDER, PROVIDER_ID, DISPLAY_NAME, PROFILE_URL, IMAGE_URL)
VALUES (1, 'admin@primavera.com', 1, 'google_admin_123', '최성조', 'https://profile.google.com/admin', 'https://profile.google.com/admin/photo.jpg'),
       (2, 'manager@primavera.com', 2, 'facebook_manager_456', '홍길동', 'https://profile.facebook.com/manager', 'https://profile.facebook.com/manager/photo.jpg'),
