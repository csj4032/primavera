...
public class PostMockControllerTest {
    ...
    public void postList() throws Exception {
        ...
        List<PostDto.ResponseForList> posts = List.of(
                PostDto.ResponseForList.builder().id(1).subject("translated_text_3 translated_text_5 translated_text_5 translated_text_3.").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(2).subject("translated_text_3 translated_text_2").writerNickName("Genius").build());
    ...
    public void postListOfPagination() throws Exception {
        ...
        List<PostDto.ResponseForList> list = List.of(
                PostDto.ResponseForList.builder().id(1).subject("translated_text_3 translated_text_5 translated_text_5 translated_text_3.").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(2).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(3).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(4).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(5).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(6).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(7).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(8).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(9).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(10).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(11).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(12).subject("translated_text_3 translated_text_2").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(13).subject("translated_text_3 translated_text_2").writerNickName("Genius").build()
        );
