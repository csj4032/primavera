...
public class PostMockControllerTest {
    ...
    public void postList() throws Exception {
        ...
        List<PostDto.ResponseForList> posts = List.of(
                PostDto.ResponseForList.builder().id(1).subject("connection Endpoint Endpoint connection.").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(2).subject("connection test").writerNickName("Genius").build());
    ...
    public void postListOfPagination() throws Exception {
        ...
        List<PostDto.ResponseForList> list = List.of(
                PostDto.ResponseForList.builder().id(1).subject("connection Endpoint Endpoint connection.").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(2).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(3).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(4).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(5).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(6).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(7).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(8).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(9).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(10).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(11).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(12).subject("connection test").writerNickName("Genius").build(),
                PostDto.ResponseForList.builder().id(13).subject("connection test").writerNickName("Genius").build()
        );
