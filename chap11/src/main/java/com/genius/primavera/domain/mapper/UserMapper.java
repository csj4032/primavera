...
public interface UserMapper {
    ...
    String SELECT_FROM_USER_JOIN_CONNECTION = "SELECT A.ID, A.EMAIL, NICKNAME, PASSWORD, STATUS, B.PROVIDER, B.PROVIDER_ID, B.PROFILE_URL, B.IMAGE_URL, CREATED_AT, UPDATED_AT FROM USER A INNER JOIN USER_CONNECTION B ON A.EMAIL = B.EMAIL ";
