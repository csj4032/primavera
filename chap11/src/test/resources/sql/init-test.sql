...
VALUES (1, 'board@primavera.com', '{noop}test', 'BoardAdmin', 'ACTIVE'),
       (2, 'writer@primavera.com', '{noop}test', 'Writer', 'ACTIVE'),
       (3, 'reader@primavera.com', '{noop}test', 'Reader', 'ACTIVE')
...
-- 게시글 테스트 데이터
INSERT INTO POSTS (ID, TITLE, CONTENT, AUTHOR_ID, STATUS, VIEW_COUNT, LIKE_COUNT)
VALUES (1, 'Board System Test Post 1', 'This is a test post for the board system. Content includes various features.', 1, 'PUBLISHED', 100, 15),
       (2, 'Board System Test Post 2', 'Another test post with different content and features.', 2, 'PUBLISHED', 75, 8),
       (3, 'Draft Post', 'This is a draft post for testing purposes.', 2, 'DRAFT', 0, 0)
ON DUPLICATE KEY UPDATE ID = VALUES(ID);

-- 댓글 테스트 데이터
INSERT INTO COMMENTS (ID, POST_ID, AUTHOR_ID, CONTENT, STATUS)
VALUES (1, 1, 2, 'Great post! Very informative.', 'ACTIVE'),
       (2, 1, 3, 'Thank you for sharing this.', 'ACTIVE'),
       (3, 2, 1, 'Nice work on this board system.', 'ACTIVE')
ON DUPLICATE KEY UPDATE ID = VALUES(ID);
