...
VALUES (1, 'oauth2@primavera.com', '{noop}test', 'OAuth2Test', 'ACTIVE'),
       (2, 'social@primavera.com', '{noop}test', 'SocialTest', 'ACTIVE'),
       (3, 'kakao@primavera.com', '{noop}test', 'KakaoUser', 'ACTIVE'),
       (4, 'google@primavera.com', '{noop}test', 'GoogleUser', 'ACTIVE')
