...
class ContainerConfigurationTest {
    ...
    void testGetUsernameOrDefault() {
        ...
        assertEquals("test", specWithoutUsername.getUsernameOrDefault(),
    ...
    void testGetPasswordOrDefault() {
        ...
        assertEquals("test", specWithoutPassword.getPasswordOrDefault(),
    ...
    void testGetDatabaseOrDefault() {
        ...
        assertEquals("test", specWithoutDatabase.getDatabaseOrDefault(),
    ...
    void testNoArgsConstructor() {
        ...
        assertEquals("test", spec.getUsernameOrDefault(), "Should use default username");
        assertEquals("test", spec.getPasswordOrDefault(), "Should use default password");
        assertEquals("test", spec.getDatabaseOrDefault(), "Should use default database");
    ...
    void testAllArgsConstructor() {
        ...
        ContainerConfiguration.ContainerSpec spec = new ContainerConfiguration.ContainerSpec(
            "test:latest", "test_db", "test_user", "test_pass", "init.sql", 120, env, aliases
        );
