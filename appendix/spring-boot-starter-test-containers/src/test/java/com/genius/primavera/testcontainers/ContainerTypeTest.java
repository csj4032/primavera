...
class ContainerTypeTest {
    ...
    void testRedisDefaultImage() {
        assertEquals("redis:7-alpine", ContainerType.REDIS.getDefaultImage(),
            "Redis should have correct default image");
    ...
    void testMySqlDefaultImage() {
        assertEquals("mysql:8.0", ContainerType.MYSQL.getDefaultImage(),
            "MySQL should have correct default image");
    ...
    void testElasticsearchDefaultImage() {
        assertEquals("elasticsearch:8.11.0", ContainerType.ELASTICSEARCH.getDefaultImage(),
            "Elasticsearch should have correct default image");
    ...
    void testAllContainerTypesDefined() {
        ...
        for (ContainerType type : types) {
            assertNotNull(type.getDefaultImage(), 
                "Container type " + type + " should have default image");
            assertFalse(type.getDefaultImage().isEmpty(), 
                "Container type " + type + " default image should not be empty");
        }
